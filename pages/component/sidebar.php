...
<div class="bg-sidebar vh-100 w-50 position-fixed">
            <div class="log d-flex justify-content-between">
                <h1 class="E-classe text-start ms-3 ps-1 mt-3 h6 fw-bold">PinTree</h1>
            ...
            <div class=" bg-list d-flex flex-column align-items-center fw-bold gap-2 mt-4 ">
                <ul class="d-flex flex-column list-unstyled">
                    ...
                    <!-- <li class="h7"><a class=" nav-link text-dark" href="category_list.php"><i
                                class="fal fa-bookmark me-2"></i> <span>Categories</span></a></li> -->
                    <li class="h7"><a class=" nav-link text-dark" href="events_list.php"><i
                                class="far fa-graduation-cap me-2"></i> <span>Events</span></a></li>
