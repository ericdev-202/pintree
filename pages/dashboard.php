...
<body class="bg-content">
    <main class="dashboard d-flex">
        ...
        <?php 
            ...
            $nbr_students = $con->query("SELECT * FROM events_list");
            $nbr_students = $nbr_students->rowCount();

            $nbr_category = $con->query("SELECT CategoryName FROM events_list GROUP BY CategoryName");
            $nbr_category = $nbr_category->rowCount();
            ...
            <div class="cards row gap-3 justify-content-center mt-5">
                ...
                <div class=" card__items card__items--yellow col-md-3 position-relative">
                    ...
                    <div class="card__payments">
                        <span class="h5 fw-bold nbr">000</span>
                    </div>
                </div>
